...
`@xquik/tweetclaw@1.6.27` was published to npm on 2026-05-08 after marking the authenticated media-download endpoint as not MPP-eligible in the runtime catalog and adding a regression test. npm shasum is `6a75ea6b07628fb39d96974d649afc34eb05232d`; npm integrity is `sha512-3u7GwG6Rmui+/DtBwwnVW1uThyBDYRmRyAwTr4gHdI7rYDopkf9vM+RYu+ij9de++eiF3wjVofXYMLgEnqEiCw==`; source commit is `88b7879ed62c1a47ed33833afabe4654d9d86d9c`. ClawPack dry-run produced sha256 `ab25bb7f29b5dd86f23a371601193e4b5706f6a6d6630d070ed11497733b7d7b`, 57 files, and `code-plugin` family metadata, but ClawHub publish failed because the current owner token is `kriptoburak` and the package scope is `@xquik`. ClawHub latest remains `1.6.26`; no `1.6.27` ClawHub scan exists yet.
