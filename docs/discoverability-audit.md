...
- Latest OpenClaw stable checked as of 2026-06-08 22:31 UTC:
  `openclaw@2026.6.1`; npm beta is `2026.6.5-beta.3`; source main package
  metadata reports `2026.6.1`.
- Official OpenClaw docs checked as of 2026-06-08 22:31 UTC: `llms.txt`,
...
- Known blocker: GitHub Dependabot alerts 22-25 and local omit-dev npm audit
  ...
  2026-06-08 22:31 UTC. Track upstream OpenClaw issue/PR 91301/91303 until
...
- 2026-06-08 22:31 UTC: crawler-first monitoring read back 100 open authored
  PRs; thread-level checks found no unresolved actionable bot-review threads.
- External submission: opened `khaterdev/kirie#2`, a MIT-licensed PR that adds
  confirmation, untrusted-content, credential-safety, and optional
  TweetClaw/OpenClaw managed-research guidance to Kirie's `twitter-x` skill.
