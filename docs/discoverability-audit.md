...
Status: PR open; 2026-05-07 19:21 UTC recheck found it mergeable with no comments.
...
- PR 3, `Add TweetClaw plugin`, is open, mergeable, non-draft, comment-free, review-free, and has no status checks as of 2026-05-07 19:21 UTC.
- The PR body uses real Markdown newlines and does not contain escaped `\n` sequences.
- 2026-05-07 19:21 UTC recheck read README, CONTRIBUTING, CC0 license, PR template, validation workflow, link-checker workflow, open and closed PRs/issues, PR 3 body formatting, and default-branch clone search for `tweetclaw`, `xquik`, `x-twitter-scraper`, and `@xquik/tweetclaw`; CODE_OF_CONDUCT remains absent and the default branch still has no TweetClaw or Xquik entry until PR 3 merges.
...
- 2026-05-07 18:50 UTC recheck read README, CONTRIBUTING, MIT license, PR template, agent-submission, agent-request, and bug-report issue templates, open and closed PRs/issues, live PR diff and checks, PR body formatting, and default-branch clone search for `tweetclaw`, `xquik`, `x-twitter-scraper`, and `@xquik/tweetclaw`; CODE_OF_CONDUCT remains absent. PR 69 remains open, mergeable, non-draft, comment-free, review-free, and check-free with no literal backslash-n sequences in the body. Fresh GitHub repository search returned no higher-quality repo-native contribution path than monitoring PR 69.
...
- Push workflow run https://github.com/Xquik-dev/tweetclaw/actions/runs/25515026530 completed successfully for commit `b42489c`.
...
- https://context7.com/xquik-dev/tweetclaw?tab=benchmark
- https://context7.mintlify.dev/docs/adding-libraries
- https://context7.com/docs/howto/private-sources
...
- 2026-05-07 16:49 UTC heartbeat research confirmed npm `openclaw` latest remains `2026.5.6`, npm `@xquik/tweetclaw` latest remains `1.6.22`, and ClawHub latest plus version-specific package inspect still report `1.6.22` clean for top-level package scan, source-linked verification scan, and version-specific static scan on engine `v2.4.22`. Official OpenClaw tool docs still support `tools.alsoAllow` for optional plugin tools, direct Context7 library-update docs still list refresh thresholds of 1 day, 15 days, 30 days, and 45 days, and direct Xquik billing and API overview Markdown still describe 31 MPP read-only endpoints with authenticated media downloads outside MPP.
- 2026-05-07 16:49 UTC discoverability check re-read mergisi/awesome-openclaw-agents README, CONTRIBUTING, MIT license, PR template, agent-submission, agent-request, and bug-report issue templates, open and closed PRs/issues, live PR diff, PR checks, PR body formatting, GitHub PR/code/repository searches, and default-branch clone search for `tweetclaw`, `xquik`, `x-twitter-scraper`, and `@xquik/tweetclaw`. CODE_OF_CONDUCT remains absent; PR 69 remains open, mergeable, non-draft, comment-free, review-free, and has no status checks. Fresh GitHub searches returned no higher-quality repo-native contribution path than monitoring PR 69 and avoiding duplicate submissions.
- 2026-05-07 17:07 UTC heartbeat research confirmed npm `openclaw` latest remains `2026.5.6`, the GitHub release page for `v2026.5.6` remains live, and GitHub compare `v2026.5.5...v2026.5.6` remains a maintenance-only delta with no material TweetClaw runtime or manifest compatibility impact. Official OpenClaw manifest docs now explicitly say ClawHub-published plugins should use `openclaw.install.clawhubSpec` as the preferred remote source, while `npmSpec` remains the compatibility fallback. Direct OpenClaw tool docs still support `tools.alsoAllow`, direct Xquik billing and API overview Markdown still describe 31 MPP read-only endpoints with authenticated media downloads outside MPP, and direct Context7 library-update docs still list refresh thresholds of 1 day, 15 days, 30 days, and 45 days.
- 2026-05-07 17:15 UTC published `@xquik/tweetclaw@1.6.23` to npm and ClawHub after adding exact `clawhub:@xquik/tweetclaw@1.6.23` install metadata, making `defaultChoice` `clawhub`, retaining exact npm fallback `@xquik/tweetclaw@1.6.23`, and extending the version guard to keep both specs in sync on future releases. `npm run check:all` passed with 161 tests and 100% coverage; `npm pack --dry-run --json` and `node scripts/clawpack.mjs dry-run` confirmed a 57-file npm-pack code-plugin from source commit `ae14deacbe5b7f89f66698d7770dd1a0ff58cb06`.
...
- 2026-05-07 18:06 UTC heartbeat research confirmed npm `openclaw` latest remains `2026.5.6`, while npm dist-tags still include beta `2026.5.7-beta.1`. GitHub releases still list `v2026.5.6` as latest stable, and `v2026.5.7-beta.1` still has no release page. No TweetClaw package bump is needed until a stable OpenClaw release or documented plugin API, manifest, package, install, scan, or diagnostics change materially affects TweetClaw.
- 2026-05-07 18:06 UTC live registry checks confirmed npm `@xquik/tweetclaw` latest remains `1.6.23` with shasum `6fc8b7f2301428afcadda4baeeff50a651dcd1d1`; ClawHub latest and version-specific inspect report `1.6.23` clean for package, source-linked verification, static, LLM, and fallback security scans on engine `v2.4.22`; `npm audit --omit=dev` found 0 vulnerabilities.
...
- 2026-05-07 18:50 UTC heartbeat research confirmed npm `openclaw` latest remains `2026.5.6` with beta dist-tag `2026.5.7-beta.1`, GitHub releases still list `v2026.5.6` as latest stable, and npm `@xquik/tweetclaw` latest remains `1.6.23` with shasum `6fc8b7f2301428afcadda4baeeff50a651dcd1d1`. ClawHub latest and version-specific package inspect still report `1.6.23` clean for package, source-linked verification, static, LLM, and fallback security scans on engine `v2.4.22`; `xquik@1.6.13` and `tweetclaw@1.1.9` skills remain clean; `npm audit --omit=dev` found 0 vulnerabilities. Direct Context7 docs still list refresh thresholds of 1 day, 15 days, 30 days, and 45 days, while search snippets can still show stale 3, 10, 20, and 30 day thresholds. Direct Xquik billing still describes 31 MPP read-only endpoints with authenticated media downloads outside MPP.
- 2026-05-07 18:50 UTC public hygiene checks found no tracked or non-ignored untracked secret-like filenames. Confidential-term scanning found only expected token environment variable names in GitHub workflow examples and release instructions, with no secret values.
- 2026-05-07 18:50 UTC discoverability check re-read `mergisi/awesome-openclaw-agents` README, CONTRIBUTING, MIT license, PR template, issue templates, open and closed PRs/issues, PR 69 diff/checks/body formatting, and default-branch clone search for `tweetclaw`, `xquik`, `x-twitter-scraper`, and `@xquik/tweetclaw`; CODE_OF_CONDUCT remains absent. PR 69 remains open, mergeable, non-draft, comment-free, review-free, and check-free. `composio-community/awesome-openclaw-plugins` PR 5 and PR 7 also remain open, mergeable, non-draft, comment-free, review-free, and check-free. No new external PR or issue was opened.
- 2026-05-07 19:21 UTC heartbeat research confirmed npm `openclaw` latest remains `2026.5.6` with beta dist-tag `2026.5.7-beta.1`, GitHub releases still list `v2026.5.6` as latest stable, and npm `@xquik/tweetclaw` latest remains `1.6.23` with shasum `6fc8b7f2301428afcadda4baeeff50a651dcd1d1`. ClawHub latest and version-specific package inspect still report `1.6.23` clean for package, source-linked verification, static, LLM, and fallback security scans on engine `v2.4.22`; `xquik@1.6.13` and `tweetclaw@1.1.9` skills remain clean; `npm audit --omit=dev` found 0 vulnerabilities.
...
- 2026-05-07 20:02 UTC published `@xquik/tweetclaw@1.6.24` to npm and ClawHub after improving Context7 and GitHub discoverability with focused setup/workflow docs, README Context7 links, and synchronized install metadata. `npm run check:all` passed with 161 tests and 100% coverage; `npm pack --dry-run --json`, registry `npm pack @xquik/tweetclaw@1.6.24 --dry-run --json`, and `node scripts/clawpack.mjs dry-run` confirmed a 57-file npm-pack code-plugin from source commit `21b6a5ebbfe4559a5b7303cd5ebdba093247d9c6`.
- 2026-05-07 20:02 UTC npm `@xquik/tweetclaw` latest is `1.6.24`, published at `2026-05-07T20:01:19.306Z`, with npm shasum `5da8308228ac6fe6151d4bfa362da279301e0b07` and npm integrity `sha512-OMeeJWqs3dSjXvTWxLnHydPVYEAVvF8mgdCy27Nljqd+QMKaAqfwFaffR54qaTnGbfOMx/7VvBIg3dCBqiaiIA==`. ClawHub latest package inspect reports `@xquik/tweetclaw@1.6.24` as an npm-pack code-plugin under owner `kriptoburak`, source-linked to commit `21b6a5ebbfe4559a5b7303cd5ebdba093247d9c6`; version-specific inspect with `--version 1.6.24` reports a clean static scan on engine `v2.4.22`, and explicit rescan request `sd78ne5291p1jgkkmvn39898zx869fxp` remained pending for top-level package and source-linked verification scans.
- 2026-05-07 20:03 UTC automation prompt baseline was updated to treat `@xquik/tweetclaw@1.6.24` as latest, preserve the current Context7 benchmark score `47`, and continue monitoring pending ClawHub package and verification scans from rescan request `sd78ne5291p1jgkkmvn39898zx869fxp`.
...
- Published `@xquik/tweetclaw@1.6.23` to npm and ClawHub after making exact ClawHub package installs the preferred OpenClaw onboarding source while preserving an exact npm fallback.
- Version-specific ClawHub inspection reports `staticScan.status: "clean"` with no findings on engine `v2.4.22`; explicit package rescan request `sd7c7nqby0btrteqh556061qyd869e8r` completed clean for top-level package and verification records by 2026-05-07 17:21 UTC.
- Automation prompt updated on 2026-05-07 to treat `@xquik/tweetclaw@1.6.23` as latest with clean ClawHub static, package, and verification scans, and to preserve exact ClawHub plus npm install metadata on future releases.
- Published `@xquik/tweetclaw@1.6.24` to npm and ClawHub after adding focused Context7 setup/workflow docs, README Context7 links, and parser rules for the claimed Context7 library.
- Version-specific ClawHub inspection reports `staticScan.status: "clean"` with no findings on engine `v2.4.22`; explicit package rescan request `sd78ne5291p1jgkkmvn39898zx869fxp` remained pending for top-level package and verification records at 2026-05-07 20:02 UTC.
