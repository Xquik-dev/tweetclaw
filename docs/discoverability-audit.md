...
Status: PR open; 2026-05-07 11:21 UTC recheck found it mergeable with no comments, reviews, or checks.
...
- Version-specific ClawHub inspection reports `staticScan.status: "clean"` with no findings on engine `v2.4.22`; explicit package rescan request `sd762r105pcgtrj8g01d3fzsn1869qpk` was accepted and remained pending for top-level package and verification records at 2026-05-07 13:24 UTC.
