...
- Latest OpenClaw stable checked as of 2026-06-08 20:16 UTC:
  `openclaw@2026.6.1`; npm beta is `2026.6.5-beta.2`; source main package
  metadata reports `2026.6.1`.
- Official OpenClaw docs checked as of 2026-06-08 20:16 UTC: `llms.txt`,
...
- Known blocker: GitHub Dependabot alerts 22-25 and local omit-dev npm audit
  ...
  2026-06-08 20:16 UTC. Track upstream OpenClaw issue/PR 91301/91303 until
...
- 2026-06-08 20:05 UTC: crawler-first monitoring read back 100 open authored
  PRs; no maintainer-actionable repair blocked fresh outreach.
- External submission: opened
  `Kevin-Liu-01/X-Agent#1`, an issue-only proposal for optional
  TweetClaw/OpenClaw source packets before X-Agent routes reads and
  MCP-backed account actions. Issue path was used because the repo has no
