...
- OpenClaw npm checked as of 2026-06-17 03:58 UTC: latest
...
- ClawHub route `clawhub.ai/plugins/@xquik/tweetclaw` returned HTTP 200
  on 2026-06-17 03:58 UTC, but latest ClawHub page remains `1.6.26` and
...
- 2026-06-17 03:58 UTC: model/effort selectors unavailable. Crawler returned 0
  ...
  non-actionable.
- Fresh PR: https://github.com/adam-doco/Twitter-AI-agent/pull/1 adds optional
  public X/Twitter source-evidence docs, updates the README tree, and keeps
  TweetClaw as a replaceable evidence source. Readback: open, clean, mergeable,
  ready, docs only.
- Checks: target links, HTML parse, public hygiene, OpenClaw docs/packages,
