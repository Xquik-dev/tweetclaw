...
- GitHub repo metadata as of 2026-05-09 10:47 UTC: public, MIT, default branch `master`, 37 stars, 3 forks, description mentions posting tweets, replies, likes, retweets, follows, DMs, OpenClaw, structured Xquik endpoints, and 99 agent-callable endpoints; topics include OpenClaw, TweetClaw, Xquik, X/Twitter, MCP, pay-per-use, skills, automation, ClawHub, Context7, social media, and data extraction.
- Open GitHub issues and PRs in `Xquik-dev/tweetclaw`: none as of 2026-05-09 10:47 UTC.
...
- Current observed benchmark on 2026-05-09 10:41 UTC: static HTML page data showed benchmark score `81`, Trust Score `7.5`, 180 snippets, 8 pages, 0 parse failures, last update `2026-05-09T04:19:05.976Z`, and parsed source SHA `5fcc2c6d574120a90fd4d5a41409c141fd948dca`. Context7 has parsed the latest docs-only audit commit, but old finalized versions and stale generated snippets still remain.
...
- OpenClaw npm latest and beta are both `2026.5.7` as of 2026-05-09 10:41 UTC.
...
2026-05-09 10:47 UTC:

- Local repo clean at `7a15e1b` before edits; no untracked non-ignored files.
...
- Context7 static HTML page data still shows benchmark score `81`, Trust Score `7.5`, 180 snippets, 8 pages, 0 parse failures, last update `2026-05-09T04:19:05.976Z`, and parsed source SHA `5fcc2c6d574120a90fd4d5a41409c141fd948dca`. Old finalized versions still appear and stale 32-endpoint/media-download snippets remain, so the next useful action remains Context7 Versions-tab cleanup or documented owner-side cache removal.
- Security and registry checks: Dependabot open alerts are 0, and `npm audit --audit-level=low` reports 0 vulnerabilities.
- External placement action: opened https://github.com/hridaydutta123/awesome-twitter-tools/pull/34 after reading README, code of conduct, repo metadata, issue state, PR state, missing contribution and license files despite the README CC0 badge, and duplicate search results. The PR adds TweetClaw as a distinct tool next to the existing Xquik platform row with concrete wording for search tweets, post tweets and replies, follower export, monitors, webhooks, direct messages, and giveaway draws.
