...
- Current observed benchmark on 2026-05-09 14:25 UTC: the visible public benchmark page showed score `78.7`, Trust Score `7.5`, 180 snippets, and `Update: 1 hour ago`. At 2026-05-09 13:51 UTC the same public page still showed `84.1`, so keep treating this swing as Context7 cache/version drift rather than a TweetClaw source change.
