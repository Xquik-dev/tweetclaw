...
- OpenClaw npm checked as of 2026-06-17 04:08 UTC: latest
...
- ClawHub route `clawhub.ai/plugins/@xquik/tweetclaw` returned HTTP 200
  on 2026-06-17 04:08 UTC, but latest ClawHub page remains `1.6.26` and
...
- 2026-06-17 04:08 UTC: model/effort selectors unavailable. Crawler returned 0
  ...
  non-actionable.
- Fresh PR: https://github.com/agentii-ai/twitter-init-kit/pull/1 adds a
  source-evidence log to Twitter campaign specs, fixes stale release links, and
  adds the xquik.com NHS badge in an existing badge row. Readback: open, clean,
  mergeable, ready, docs/templates only.
- Checks: target links, template tests, public hygiene, OpenClaw docs/packages,
  public URL probes, package dry run, build, and TweetClaw `check:all` passed.
