...
- GitHub repo metadata as of 2026-05-09 04:10 UTC: public, MIT, default branch `master`, 37 stars, 3 forks, description mentions posting tweets, replies, likes, retweets, follows, DMs, OpenClaw, structured Xquik endpoints, and 99 agent-callable endpoints; topics include OpenClaw, TweetClaw, Xquik, X/Twitter, MCP, pay-per-use, skills, automation, ClawHub, Context7, social media, and data extraction.
- Open GitHub issues and PRs in `Xquik-dev/tweetclaw`: none as of 2026-05-09 04:10 UTC.
...
- Current observed benchmark on 2026-05-09 04:10 UTC: static HTML page data showed benchmark score `82.6`, Trust Score `7.5`, 180 snippets, 8 pages, 0 parse failures, last update `2026-05-09T00:51:33.456Z`, and parsed source SHA `0204b95dbf8a270859f093aae0e2d52d3ed3e669`. The visible/static snippet count still drifts between rendered page elements and embedded data; treat this as Context7 presentation or cache drift.
...
- OpenClaw npm latest and beta are both `2026.5.7` as of 2026-05-09 04:10 UTC.
...
2026-05-09 04:10 UTC:

- Local repo clean at `7876e9b` before edits; no untracked non-ignored files.
...
- External placement action: opened https://github.com/RoggeOhta/awesome-codex-cli/pull/25 after reading README, CONTRIBUTING, CC0 license, repo metadata, open PRs/issues, and duplicate search results. The PR adds TweetClaw to Domain-Specific Skills with concrete user-search wording for search tweets, post tweets and replies, export followers, monitor tweets, direct messages, webhooks, and giveaway draws; the PR body was read back from GitHub after creation.
- External validation: `git diff --check` passed in the fork. The NHS badge was not added because the target badge area is for the directory itself, and an xquik.com readiness badge would not help maintainers evaluate that list entry.
