...
Current source metadata targets OpenClaw `2026.6.9` or newer. Update OpenClaw before testing source builds or freshly packed artifacts from this repository.
...
If install fails, verify OpenClaw is at least `2026.6.9` for current source builds and install the published package.
